  ...
  if (selectedImage !== null) {
    return (
      <View style={styles.containerPic}>
        ...
        <Text style={styles.buttonTextPic}>Add another photo</Text>
      </TouchableOpacity>
  ...
  return (
    <View style={styles.profileContainer}>
        <TouchableOpacity style={styles.profileIcon}>
          <Text style={styles.profileIconText}>AA</Text>
        </TouchableOpacity>
        <Text style={styles.userInfo}> @aa5102 </Text>

        <Image
          source={require('.//assets/img/weather.png')}
          style={styles.imageIcon}
        />
        <Text style={styles.weather}>MONDAY, 26th April</Text>
        <Text style={styles.weather}>Location: Dubrovnik, Croatia</Text>
        <Text style={styles.weather}>Temperature: 17°C </Text>
        <Text style={styles.weather}>RealFeel: 18°C</Text>
        <TouchableOpacity style={styles.logOut}><Text style={styles.logOutText}>Click here to Log Out</Text></TouchableOpacity>
      </View>
  );
}
